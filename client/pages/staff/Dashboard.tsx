...
const hours = Array.from({ length: 12 }, (_, i) => ({ h: i*2, v: Math.round(50 + Math.random()*60) }));
    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Quick POS & today’s performance</p>
        </div>
        <div className="flex gap-2">
          <Button asChild><Link to="/billing">Open POS</Link></Button>
          <Button asChild variant="outline"><Link to="/billing/my">My Bills</Link></Button>
          <Button asChild variant="outline"><Link to="/sales">Return / Exchange</Link></Button>
        </div>
      </div>
      ...
      <Card>
        <CardHeader><CardTitle>My Last 5 Bills</CardTitle></CardHeader>
        <CardContent>
          <Table>
      ...
      <Card>
        <CardHeader><CardTitle>Today’s Hourly Sales</CardTitle><CardDescription>Mini sparkline</CardDescription></CardHeader>
        <CardContent>
