                ...
                <TableRow key={s.id}>
                  <TableCell>
                    <Input
                      defaultValue={s.name}
                      onBlur={(e) =>
                        addOrUpdateSupplier({ id: s.id, name: e.target.value })
                      }
                    />
                  </TableCell>
                  <TableCell>
                    <Input
                      ...
                      onBlur={(e) =>
                        addOrUpdateSupplier({ id: s.id, email: e.target.value })
                      }
                    />
                  </TableCell>
                  <TableCell>
                    <Input
                      defaultValue={(s as any).phone || ""}
                      onBlur={(e) =>
                        addOrUpdateSupplier({ id: s.id, phone: e.target.value })
                      }
                    />
                  </TableCell>
