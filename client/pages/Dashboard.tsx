    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-muted-foreground">
          Key metrics and quick actions for your store
        </p>
      </div>
      ...
      <div className="grid gap-4 md:gap-6 grid-cols-1 sm:grid-cols-2 xl:grid-cols-4">
        ...
        <MetricCard
          ...
          trend={{ value: 2, positive: false, suffix: " items" }}
        />
        <MetricCard
          title="Today’s Sales"
        ...
        <MetricCard
          ...
          icon={<ArrowDownRight className="size-4 rotate-45" />}
        ...
        <Card className="xl:col-span-2">
          <CardHeader className="flex flex-row items-center justify-between space-y-0">
            <div>
              ...
              <CardDescription>
                Monitor your recent revenue performance
              </CardDescription>
            </div>
      ...
      <Card>
        ...
        <CardContent className="grid sm:grid-cols-2 lg:grid-cols-4 gap-3">
          <Button asChild variant="default">
            <Link to="/sales">Create Invoice</Link>
          </Button>
          <Button asChild variant="outline">
            <Link to="/purchases">Receive Goods</Link>
          </Button>
          <Button asChild variant="outline">
